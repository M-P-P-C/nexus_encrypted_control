...
class hom_encrypt:
    ...
    def __init__(self):    #The "self" structure replaces "env" from Kim's paper
        ...
        pymorph.variables_define(p = 10**13, L = 10**4, r=10**1, N = 90)
        ...
        rospy.Subscriber(self.name+'/z_values', numpy_msg(Floats), self.enc, queue_size=1)
    ...
    def enc(self, data):
        ...
        if self.running:
            ...
            #print("--------------------------------------------------")
            #print "Encryption of Nexus: "+str(int(sys.argv[1]))
